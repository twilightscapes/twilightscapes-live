...
<Seo
          title={`Abandoned Gast Station Night Photography`}
          description={`Workin In A Gas Station - Abandoned Gas Stations Night Photography `}
...
<p style={{textAlign:'center', fontSize:'clamp(.8rem, 1.4rem, 2rem)', fontWeight:'bold', maxWidth:'700px', margin:'3rem  auto 0 auto'}}>Would you explore an abandoned gas station?</p>
...
export const indexQuery = graphql`
  query gasPhotos {
    allFile(filter: {extension: {regex: "/(jpg)|(jpeg)|(png)/"}, dir: {regex: "/img/gasstations/"}}) {
      edges {
        node {
          name
          id
