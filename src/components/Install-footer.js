...
{this.state.isActive ? 
<>
  <div className="installwindow" style={{fontSize:'90%',  display:'flex', flexDirection:'column', verticalAlign:'middle', lineHeight:'200%', width:'90%', margin:'0 auto', padding:' 0', border:'0px solid #333', borderRadius:'12px', maxWidth:'600px', textAlign:'center' }}>
